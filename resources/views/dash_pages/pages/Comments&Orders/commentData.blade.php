...
<section class="content">
                ...
                <div class="row justify-content-center">
                        <div class="col-12 col-lg-7">
                                    ...
                                    <div class="col-8" >
                                            ...
                                            <div class="card mb-3">
        <img src="{{$comments ->Product->image1}}"   class="card-img-top" alt="...">
        <div class="card-body">
        ...
        <a href="{{route('users')}}" ><p class="card-text"><strong class="text-muted">Comment With : </strong>{{$comments->User->name}}</p></a>
